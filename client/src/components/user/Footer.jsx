  ...
  return (
    <div className="mt-8 bg-teal-800 pt-9">
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between gap-8 sm:px-[18px] md:flex-row md:px-10">
          ...
          {/* Pages and Download App Section */}
              ...
              <ul className="mt-4 space-y-3">
                {[
                  ...
                  <li key={index}>
                    <a
                      href={link.href}
                      className="text-[15px] font-normal text-white hover:text-white/80 hover:underline"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="flex items-center justify-center py-6">
          <p className="text-[12px] font-normal text-white/80">
            © Copyright 2025, All Rights Reserved by FRYOMI. PVT. LTD
          </p>
        </div>
      </div>
    </div>
